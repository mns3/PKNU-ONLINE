...
캠퍼스 규모의 공간을 2명에서 6개월 안에 작업을 해야 했기에, AI를 활용하여 **결과물을 만들어 내는 파이프라인을 먼저 만드는 방향** 으로 접근했습니다. GIS 데이터로 정확한 스케일의 기반 형상을 확보하고, 현장 사진을 이용하여 생성형 AI가 텍스처와 모델을 제작하고, 반복 오브젝트는 PCG 알고리즘이 배치하는 구조입니다.
...
다수의 유저가 동시에 접속해 상호작용하는 네트워크 환경을 갖추고 있습니다. 채팅시스템도 구현하였습니다.
